    ...
    return (
        <div>
            <div className="card bg-base-100 w-[320px] shadow-sm p-6 text-left lexend-font">
                <figure>
                    <img className='w-[330px] h-[200px] rounded-2xl'
                    src={recipe_image}
                    alt="Shoes" />
                </figure>
                <div className="">
                    ...
                    <div className='text-[#2828281A] border mt-4'></div>
                    <div className='flex gap-2.5 mt-6 font-normal text-[16px] text-[#282828CC]'>
                        <p><i class="fa-regular fa-clock"></i> 30 minutes</p>
                        <p><i class="fa-solid fa-fire"></i> 600 calories</p>
                    </div>
                    <div className="card-actions mt-6">
                    <button onClick={()=>handleWanttocook(recipe)} className="btn rounded-[50px] bg-[#0BE58A]">Want to Cook</button>
                    </div>
                </div>
            </div>
        </div>
